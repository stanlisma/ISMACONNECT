-- Repairs profiles schema drift discovered in production: updated_at, address,
-- phone_verification_method, and phone_verified_at never landed, and the
-- handle_new_user trigger was still the pre-202605200001 version because of it.
